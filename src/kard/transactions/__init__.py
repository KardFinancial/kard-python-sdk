...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "CoreTransactionAttributes": ".types",
    "CoreTransactionRequest": ".types",
    ...
    "CreateFileUploadAttributes": ".types",
    "CreateFileUploadData": ".types",
    "CreateFileUploadRequestBody": ".types",
    "CreateFileUploadUrlResponse": ".types",
    "CreateIncomingTransactionsMultiStatus": ".errors",
    "DirectionType": ".types",
    "EarnedRewardsRange": ".types",
    "FileUploadType": ".types",
    "FileUploadUrlAttributes": ".types",
    "FileUploadUrlData": ".types",
    ...
    "Transactions_CoreTransaction": ".types",
